...
export const Select = ({ icon: Icon, error, options = [], className = '', ...props }) => {
  return (
    <div className="flex flex-col w-full">
      <div className={`flex items-center gap-3 px-4 py-2 w-full border rounded-lg transition-all ${
        ...
        <select 
          className="w-full text-sm bg-transparent outline-none text-gray-700 font-medium cursor-pointer" 
          {...props}
        >
          {options.map((opt, idx) => (
