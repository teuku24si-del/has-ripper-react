...
const MainLayouts = () => {
  return (
    /* Mengubah font layout dasar dari Montserrat ke Plus Jakarta Sans */
    <div className="flex bg-[#F4F7FE] min-h-screen font-['Plus_Jakarta_Sans',sans-serif] overflow-x-hidden antialiased select-none">
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <main className="flex-grow p-8 space-y-6 overflow-y-auto">
          ...
          {/* Header Dashboard Utama: Menyelaraskan teks judul, warna, dan tombol aksi sesuai Figma */}
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full gap-4 mb-2">
            <div>
              {/* Ketentuan 1: Admin Dashboard = plus jakarta sans bold dengan aksen warna biru figma */}
              <h2 className="text-3xl font-bold text-[#108ee9] tracking-tight">
                Admin Dashboard
              </h2>
              {/* Ketentuan 2: Deskripsi Welcome = plus jakarta sans regular */}
              <p className="text-sm font-normal text-blue-400 mt-1">
                Welcome back, here's what's happening with your travel business today.
              </p>
            </div>

            {/* Tombol filter tanggal dan export dokumen penyeimbang sisi kanan figma */}
          ...
          {/* Baris Atas: 4 StatCard dengan SVG Inline */}
